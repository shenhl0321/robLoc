...
export const showToast = (title,time=2000) =>{
...
export const getStoreDictionaryName = (key, code) => { 

	let dataArray = Vue.prototype.$store.state.dictionary[key]

	let model = dataArray.find(function(e){
		return e.code == code
	})
	if(model == null){
		return '--'
